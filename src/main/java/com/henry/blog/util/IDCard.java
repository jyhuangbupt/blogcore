...
public class IDCard {
    ...
    public static String validate(String IDStr) {
        ...
        if (GetAreaCode().get(provinceId) == null) {
            errorInfo = "无效的地区";
            return errorInfo;
        }
        ...
        switch (Integer.parseInt(strMonth)){
            ...
            case 10:
            case 12:
                flag = Integer.parseInt(strDay) <= 31 && Integer.parseInt(strDay) > 0;
                break;
            case 4:
            case 6:
            case 9:
            case 11:
                flag = Integer.parseInt(strDay) <= 30 && Integer.parseInt(strDay) > 0;
                break;
            case 2:
                if(gc.isLeapYear(Integer.parseInt(strYear))){
                    flag = Integer.parseInt(strDay) <= 29 && Integer.parseInt(strDay) > 0;
                }else {
                    flag = Integer.parseInt(strDay) <= 28 || Integer.parseInt(strDay) > 0;
                }
                break;
            default:
                flag = false;
